	...
	*/
	...
	static const rgb themes[][NUMBER_OF_KEYS] PROGMEM ={
		...
		{0xd6,0x00,0x00}, {0xff,0xdd,0x00}, {0xff,0xdd,0x00}, {0xbd,0x00,0x00}, 
		{0x8f,0x00,0x00}, {0xbd,0x9d,0x00}, {0xcb,0x9f,0x01}, {0x94,0x00,0x00}, 
		{0x6b,0x00,0x00}, {0x94,0x6c,0x00}, {0x98,0x77,0x01}, {0x61,0x4c,0x00}, 
		{0x70,0x4d,0x00}, {0x4d,0x00,0x00}, {0x2d,0x01,0x01}, {0x3d,0x2e,0x00}, 
		{0x3d,0x2e,0x00}},
	...
	//rgb_matrix.c has been modified as stated in keymap.c to be able to detect
